"""The two community mental health skeletons added by task 092 sample cleanly."""
...
from finetune.datagen.schema import EncounterType, FormType
from finetune.datagen.vignettes import VIGNETTES

NEW_IDS = ("cmht_discharge_to_gp", "cmht_caseload_handover")
...
def test_they_cover_encounter_types_the_module_lacked():
    covered = {_vignette(i).encounter_type for i in NEW_IDS}
    assert covered == {EncounterType.DISCHARGE, EncounterType.HANDOVER}
